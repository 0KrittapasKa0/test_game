...
export const AI_NAMES = [
    'เสี่ยชัช', 'เจ๊จู', 'เฮียตี๋', 'ป๋าเบิร์ด', 'ลุงพล', 'ซ้อเจ็ด', 'น้องมายด์', 'พี่เอก', 'หมวดแจ๊ค', 'เซียนหรั่ง',
    'ตากล้อง', 'เด็กใหม่', 'ตัวตึง', 'สายเปย์', 'นักแจก', 'ดวงดี', 'มือทอง', 'จ่าต๊อก', 'น้ากล้วย', 'เฮงเฮง',
    'ทรงป๋า', 'วัยรุ่นเทสดี', 'น้องน้ำแข็ง', 'พี่หมี', 'จารย์บอย', 'ช่างแอร์', 'มือปืน', 'เด็กช่าง', 'สาวออฟฟิศ', 'มนุษย์เงินเดือน',
    'เจ๊น้ำ', 'เสี่ยหมู', 'ซ้อใหญ่', 'เฮียหลง', 'อาแปะ', 'อาเจ๊ก', 'อาซิ่ม', 'น้าหมู', 'ป้าแมว', 'คุณนาย',
    'ไรเดอร์', 'วินมอไซค์', 'แท็กซี่ซิ่ง', 'แม่ค้าออนไลน์', 'พ่อค้าแซ่บ', 'เซียนเต่า', 'เทพทรู', 'สายฟรี', 'สายมู', 'ลูกกตัญญู',
    'พ่อบ้านใจกล้า', 'แม่บ้านสายโหด', 'เด็กหอ', 'คนโสด', 'คนคลั่งรัก', 'แอบแซ่บ', 'หัวหน้าเผ่า', 'ลูกสมุน', 'นินจา', 'ซามูไร',
    'อัศวิน', 'นักเวทย์', 'จอมยุทธ์', 'ยอดฝีมือ', 'มือสมัครเล่น', 'ขอทานน้อย', 'เศรษฐีใหม่', 'ยาจก', 'เทพแห่งดวง', 'ล้มละลาย',
    'หมดตัวแล้ว', 'รวยเละเทะ', 'ชิปล้นมือ', 'สู้ตาย', 'ไม่ยอมแพ้', 'ตาดีได้', 'ตาร้ายเสีย', 'วัดใจ', 'เทหมดตัก', 'วัดดวงแหลก',
    'คนจริงเดนตาย', 'สายซุ่มเงียบ', 'มือปราบไพ่', 'โจรหน้าหล่อ', 'สวยสังหาร', 'นางพญา', 'เจ้าพ่อ', 'มาเฟียขาสั้น', 'สายปั่น', 'ตัวฟาร์ม',
    'น้องหมวย', 'พี่บ่าว', 'สาวดอย', 'เด็กแว้น', 'สก๊อย', 'คนเลี้ยงไก่', 'ผู้ใหญ่บ้าน', 'กำนัน', 'อบต.', 'ตัวประกอบ'
];
