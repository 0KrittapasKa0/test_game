...
// ── Memoized Daily Day Item ──
interface DailyDayItemProps {
    idx: number;
    reward: number;
...
const DailyDayItem = memo(function DailyDayItem({ idx, reward, status, isDay7 }: DailyDayItemProps) {
    ...
    return (
        ...
        >
            ...
            {status === 'claimed' && (
                <div className="absolute inset-0 flex items-center justify-center bg-[rgba(0,0,0,0.7)] rounded-2xl">
